...
const skills = [
  ...
  { name: "Azure", level: 100, category: "tools" },
  { name: "Kafka", level: 80, category: "tools" },
  { name: "Kubernetes", level: 85, category: "tools" },
  { name: "Microsoft Dynamics", level: 95, category: "tools" },
  { name: "xUnit", level: 95, category: "tools" },
];
